# Checklist de Engenharia — 📺 Bibliotecas Internas e SDKs

## Escopo

Use este checklist para verificar se o material `📺 Bibliotecas Internas e SDKs` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
