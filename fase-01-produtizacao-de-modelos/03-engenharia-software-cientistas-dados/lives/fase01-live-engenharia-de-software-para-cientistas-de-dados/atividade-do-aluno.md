# Atividade do Aluno — 📺 Engenharia de Software para Cientistas de Dados

## Contexto do Problema

Você está evoluindo um projeto de Machine Learning Engineering e precisa incorporar `📺 Engenharia de Software para Cientistas de Dados` de forma verificável. A atividade pede que você traduza o conteúdo da live em uma decisão técnica acompanhada de evidência.
