#!/usr/bin/env python3
"""
Script completo de apoio a live: Engenharia de Software para Cientistas de Dados
...
PROFILE = {'topic': 'Engenharia de Software para Cientistas de Dados',
 'phase_label': 'Fase 01',
 'phase_name': 'Produtizacao de Modelos',
 'phase_focus': 'transformar modelos locais em componentes versionados, avaliados e '
                'consumiveis por outros sistemas',
 'scenario': 'qualidade de codigo para ML',
 'concepts': ['type hints', 'test doubles', 'separacao de responsabilidades'],
 'risks': ['metricas sem criterio de aceite',
           'resultado sem evidencia reproduzivel',
           'decisao tecnica sem trade-off documentado'],
 'steps': ['Separar preparacao de dados, inferencia e apresentacao.',
           'Escrever um contrato minimo para entrada e saida do modelo.',
           'Medir qual mudanca ficaria arriscada sem teste.'],
 'gates': [{'name': 'modularidade',
            'value': 0.88,
            'threshold': 0.8,
            'evidence': 'funcoes pequenas e responsabilidades claras'},
           {'name': 'testabilidade',
            'value': 0.76,
            'threshold': 0.7,
            'evidence': 'componentes podem ser verificados isoladamente'},
           {'name': 'contratos',
            'value': 0.84,
            'threshold': 0.8,
            'evidence': 'entradas e saidas estao explicitas'},
           {'name': 'manutenibilidade',
            'value': 0.81,
            'threshold': 0.75,
            'evidence': 'mudancas comuns sao localizadas'}],
