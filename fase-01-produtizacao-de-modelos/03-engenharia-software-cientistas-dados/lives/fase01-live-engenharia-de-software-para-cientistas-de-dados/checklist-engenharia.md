# Checklist de Engenharia — 📺 Engenharia de Software para Cientistas de Dados

## Escopo

Use este checklist para verificar se o material `📺 Engenharia de Software para Cientistas de Dados` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
