#!/usr/bin/env python3
"""
Script completo de apoio a live: INDICADORES DE DESEMPENHO DE MODELOS
...
PROFILE = {'topic': 'INDICADORES DE DESEMPENHO DE MODELOS',
 'phase_label': 'Fase 01',
 ...
 'scenario': 'avaliacao RAG',
 'concepts': ['OpenEvals', 'Chroma', 'LLM-as-a-Judge'],
 'risks': ['metricas sem criterio de aceite',
           'resultado sem evidencia reproduzivel',
           'decisao tecnica sem trade-off documentado'],
 'steps': ['Definir perguntas de teste com fonte esperada.',
           'Comparar resposta, contexto recuperado e criterio de avaliacao.',
           'Registrar quando a avaliacao automatica precisa de revisao humana.'],
 'gates': [{'name': 'retrieval_precision',
            'value': 0.82,
            'threshold': 0.75,
            'evidence': 'recuperacao trouxe contexto relevante'},
           {'name': 'groundedness',
            'value': 0.78,
            'threshold': 0.7,
            'evidence': 'resposta usa fontes recuperadas'},
           {'name': 'answer_relevance',
            'value': 0.86,
            'threshold': 0.8,
            'evidence': 'resposta atende a pergunta'},
           {'name': 'traceability',
            'value': 0.9,
            'threshold': 0.85,
            'evidence': 'resultado aponta origem e criterio'}],
