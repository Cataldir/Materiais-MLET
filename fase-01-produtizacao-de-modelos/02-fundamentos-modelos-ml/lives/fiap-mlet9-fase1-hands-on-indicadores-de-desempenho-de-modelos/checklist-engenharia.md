# Checklist de Engenharia — 📺 INDICADORES DE DESEMPENHO DE MODELOS

## Escopo

Use este checklist para verificar se o material `📺 INDICADORES DE DESEMPENHO DE MODELOS` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
