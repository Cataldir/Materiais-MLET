# Atividade do Aluno — 📺 APIs para Inferência de Modelos (Flask e FastAPI)

## Contexto do Problema

Você está evoluindo um projeto de Machine Learning Engineering e precisa incorporar `📺 APIs para Inferência de Modelos (Flask e FastAPI)` de forma verificável. A atividade pede que você traduza o conteúdo da live em uma decisão técnica acompanhada de evidência.
