# Checklist de Engenharia — 📺 APIs para Inferência de Modelos (Flask e FastAPI)

## Escopo

Use este checklist para verificar se o material `📺 APIs para Inferência de Modelos (Flask e FastAPI)` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
