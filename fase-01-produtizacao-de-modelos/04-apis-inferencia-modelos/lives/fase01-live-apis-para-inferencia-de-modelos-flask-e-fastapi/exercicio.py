#!/usr/bin/env python3
"""
Script completo de apoio a live: APIs para Inferencia de Modelos (Flask e FastAPI)
...
PROFILE = {'topic': 'APIs para Inferencia de Modelos (Flask e FastAPI)',
 'phase_label': 'Fase 01',
 ...
 'scenario': 'API de inferencia',
 'concepts': ['FastAPI', 'contrato HTTP', 'SLO'],
 'risks': ['metricas sem criterio de aceite',
           'resultado sem evidencia reproduzivel',
           'decisao tecnica sem trade-off documentado'],
 'steps': ['Definir contrato de request e response.',
           'Simular payload valido e invalido.',
           'Definir metrica de latencia e erro para a demo.'],
 'gates': [{'name': 'latencia_p95_ms',
            'value': 145.0,
            'threshold': 250.0,
            'evidence': 'tempo de resposta dentro do SLO'},
           {'name': 'validacao_payload',
            'value': 1.0,
            'threshold': 1.0,
            'evidence': 'payload invalido e rejeitado antes da inferencia'},
           {'name': 'observabilidade',
            'value': 0.82,
            'threshold': 0.75,
            'evidence': 'logs e metricas explicam falhas'},
           {'name': 'degradacao_controlada',
            'value': 0.78,
            'threshold': 0.7,
            'evidence': 'servico responde de forma segura em erro'}],
