#!/usr/bin/env python3
"""
Script completo de apoio ao grupo de estudo: Grupo de Estudos 2 - Modelagem com Redes Neurais
...
PROFILE = {'topic': 'Grupo de Estudos 2 - Modelagem com Redes Neurais',
 'phase_label': 'Fase 01',
 ...
 'tech_goal': 'defender metricas, contratos de API e criterios de qualidade para uma primeira '
              'versao produtizavel',
 'decision_options': [{'name': 'Aplicar Grupo de Estudos 2 - Modelagem com Redes Neurais ao '
                               'Tech Challenge',
                       'impact': 5,
                       'effort': 3,
                       'risk_reduction': 4},
