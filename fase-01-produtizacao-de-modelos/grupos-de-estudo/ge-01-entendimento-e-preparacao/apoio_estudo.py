#!/usr/bin/env python3
"""
Script completo de apoio ao grupo de estudo: Grupo de Estudos 1 - Entendimento e Preparacao
...
PROFILE = {'topic': 'Grupo de Estudos 1 - Entendimento e Preparacao',
 'phase_label': 'Fase 01',
 ...
 'tech_goal': 'defender metricas, contratos de API e criterios de qualidade para uma primeira '
              'versao produtizavel',
 'decision_options': [{'name': 'Aplicar Grupo de Estudos 1 - Entendimento e Preparacao ao Tech '
                               'Challenge',
                       'impact': 5,
                       'effort': 3,
                       'risk_reduction': 4},
