# Checklist de Engenharia — 📺 Gerenciamento de Dependências em ML

## Escopo

Use este checklist para verificar se o material `📺 Gerenciamento de Dependências em ML` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
