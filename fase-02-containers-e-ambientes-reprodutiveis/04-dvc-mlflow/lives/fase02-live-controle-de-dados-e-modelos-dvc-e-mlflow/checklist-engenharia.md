# Checklist de Engenharia — 📺 Controle de Dados e Modelos — DVC e MLflow

## Escopo

Use este checklist para verificar se o material `📺 Controle de Dados e Modelos — DVC e MLflow` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
