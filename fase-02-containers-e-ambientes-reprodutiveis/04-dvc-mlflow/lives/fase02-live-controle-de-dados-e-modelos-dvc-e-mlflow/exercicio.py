#!/usr/bin/env python3
"""
Script completo de apoio a live: Controle de Dados e Modelos - DVC e MLflow
...
PROFILE = {'topic': 'Controle de Dados e Modelos - DVC e MLflow',
 'phase_label': 'Fase 02',
 ...
 'phase_focus': 'tornar ambiente, dependencias, dados e artefatos reproduziveis entre maquinas '
                'e etapas',
 'scenario': 'versionamento de dados e modelos',
 'concepts': ['DVC', 'MLflow', 'model registry'],
 'risks': ['metricas sem criterio de aceite',
           'resultado sem evidencia reproduzivel',
           'decisao tecnica sem trade-off documentado'],
 'steps': ['Gerar hash de dados de entrada.',
           'Registrar parametros, metricas e artefatos do experimento.',
           'Definir criterio de promocao para o registry.'],
 'gates': [{'name': 'hash_dados',
            'value': 1.0,
            'threshold': 1.0,
            'evidence': 'dataset tem identidade verificavel'},
           {'name': 'run_rastreavel',
            'value': 0.91,
            'threshold': 0.85,
            'evidence': 'metricas apontam parametros e artefatos'},
           {'name': 'promocao_modelo',
            'value': 0.83,
            'threshold': 0.8,
            'evidence': 'champion e challenger sao comparados'},
           {'name': 'rollback',
            'value': 0.78,
            'threshold': 0.7,
            'evidence': 'versao anterior pode ser recuperada'}],
