# Atividade do Aluno — 📺 Controle de Dados e Modelos — DVC e MLflow

## Contexto do Problema

Você está evoluindo um projeto de Machine Learning Engineering e precisa incorporar `📺 Controle de Dados e Modelos — DVC e MLflow` de forma verificável. A atividade pede que você traduza o conteúdo da live em uma decisão técnica acompanhada de evidência.
...
A atividade contribui para a etapa em que o grupo precisa permitir que outra pessoa reconstrua o ambiente, os dados, o modelo e as evidências sem depender de conhecimento tácito. Guarde a evidência em material público do projeto, sem incluir dados privados, credenciais ou respostas prontas.

## Critérios de Autoavaliação

- A decisão tem relação direta com o objetivo da Fase 02.
