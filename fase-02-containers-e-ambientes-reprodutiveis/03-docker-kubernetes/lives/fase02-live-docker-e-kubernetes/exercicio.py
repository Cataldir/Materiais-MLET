#!/usr/bin/env python3
"""
Script completo de apoio a live: Docker e Kubernetes
...
PROFILE = {'topic': 'Docker e Kubernetes',
 'phase_label': 'Fase 02',
 ...
 'phase_focus': 'tornar ambiente, dependencias, dados e artefatos reproduziveis entre maquinas '
                'e etapas',
 'scenario': 'containerizacao e orquestracao',
 'concepts': ['Dockerfile', 'Kubernetes Deployment', 'HPA'],
 'risks': ['ambiente irreprodutivel', 'versao implicita', 'artefato sem rastreabilidade'],
 'steps': ['Revisar camadas do Dockerfile e variaveis de ambiente.',
           'Definir probes e limites para o container.',
           'Explicar quando escalar por CPU, fila ou latencia.'],
 'gates': [{'name': 'imagem_reprodutivel',
            'value': 0.88,
            'threshold': 0.8,
            'evidence': 'build usa contexto minimo e versoes claras'},
           {'name': 'healthcheck',
            'value': 1.0,
            'threshold': 1.0,
            'evidence': 'servico possui verificacao de saude'},
           {'name': 'resource_limits',
            'value': 0.8,
            'threshold': 0.75,
            'evidence': 'CPU e memoria possuem limites'},
           {'name': 'escala',
            'value': 0.76,
            'threshold': 0.7,
            'evidence': 'HPA ou regra de escala esta justificada'}],
