# Checklist de Engenharia — 📺 Docker e Kubernetes

## Escopo

Use este checklist para verificar se o material `📺 Docker e Kubernetes` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
