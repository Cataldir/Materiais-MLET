# Checklist de Engenharia — 📺 Pipeline de Treino e Deploy Automático

## Escopo

Use este checklist para verificar se o material `📺 Pipeline de Treino e Deploy Automático` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
