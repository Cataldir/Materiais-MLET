# Atividade do Aluno — 📺 Monitoração de Performance + Serviços de Monitoração

## Contexto do Problema

Você está evoluindo um projeto de Machine Learning Engineering e precisa incorporar `📺 Monitoração de Performance + Serviços de Monitoração` de forma verificável. A atividade pede que você traduza o conteúdo da live em uma decisão técnica acompanhada de evidência.
...
2. Execute o `exercicio.py` local e registre o comportamento observado.
...
A atividade contribui para a etapa em que o grupo precisa transformar a solução local em fluxo operável, observável e defensável em ambiente de produção. Guarde a evidência em material público do projeto, sem incluir dados privados, credenciais ou respostas prontas.

## Critérios de Autoavaliação

- A decisão tem relação direta com o objetivo da Fase 03.
