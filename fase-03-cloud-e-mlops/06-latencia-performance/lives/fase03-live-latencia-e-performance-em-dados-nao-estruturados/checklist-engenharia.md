# Checklist de Engenharia — 📺 Latência e Performance em Dados Não Estruturados

## Escopo

Use este checklist para verificar se o material `📺 Latência e Performance em Dados Não Estruturados` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
