#!/usr/bin/env python3
"""
Script completo de apoio ao grupo de estudo: Grupo de Estudos 1 - Deploy em Nuvem e Escolha Arquitetural
...
PROFILE = {'topic': 'Grupo de Estudos 1 - Deploy em Nuvem e Escolha Arquitetural',
 'phase_label': 'Fase 03',
 ...
 'tech_goal': 'transformar a solucao local em fluxo operavel, observavel e defensavel em '
              'producao',
 'decision_options': [{'name': 'Aplicar Grupo de Estudos 1 - Deploy em Nuvem e Escolha '
                               'Arquitetural ao Tech Challenge',
                       'impact': 5,
                       'effort': 3,
                       'risk_reduction': 4},
