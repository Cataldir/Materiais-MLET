#!/usr/bin/env python3
"""
Script completo de apoio ao grupo de estudo: Grupo de Estudos 2 - CI/CD e Pipeline Automatizado
...
PROFILE = {'topic': 'Grupo de Estudos 2 - CI/CD e Pipeline Automatizado',
 'phase_label': 'Fase 03',
 ...
 'tech_goal': 'transformar a solucao local em fluxo operavel, observavel e defensavel em '
              'producao',
 'decision_options': [{'name': 'Aplicar Grupo de Estudos 2 - CI/CD e Pipeline Automatizado ao '
                               'Tech Challenge',
                       'impact': 5,
                       'effort': 3,
                       'risk_reduction': 4},
