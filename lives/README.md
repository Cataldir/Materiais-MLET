...
|------|-------|------|-----------|-----------|------|
| 2026-03-17 | 9MLET | Indicadores de Desempenho de Modelos | Apresenta indicadores de avaliação para sistemas de RAG | Pedro Almeida | https://github.com/Cataldir/Materiais-MLET/tree/plbalmeida/lives/fiap-mlet9-fase1-hands-on-indicadores-de-desempenho-de-modelos |
