#!/usr/bin/env python3
"""
Script completo de apoio ao grupo de estudo: Grupo de Estudos 1 - Entendimento do Problema e Pipeline de Dados
...
PROFILE = {'topic': 'Grupo de Estudos 1 - Entendimento do Problema e Pipeline de Dados',
 'phase_label': 'Fase 05',
 ...
 'phase_focus': 'operar aplicacoes generativas com avaliacao, guardrails, observabilidade e '
                'seguranca',
 'tech_goal': 'integrar dados, modelo, agente, avaliacao e governanca em uma solucao '
              'generativa demonstravel e segura',
 'decision_options': [{'name': 'Aplicar Grupo de Estudos 1 - Entendimento do Problema e '
                               'Pipeline de Dados ao Tech Challenge',
                       'impact': 5,
                       'effort': 3,
                       'risk_reduction': 4},
