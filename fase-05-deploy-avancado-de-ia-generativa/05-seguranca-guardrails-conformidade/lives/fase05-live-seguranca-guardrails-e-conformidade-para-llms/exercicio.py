#!/usr/bin/env python3
"""
Script completo de apoio a live: Seguranca, Guardrails e Conformidade para LLMs
...
PROFILE = {'topic': 'Seguranca, Guardrails e Conformidade para LLMs',
 'phase_label': 'Fase 05',
 ...
 'phase_focus': 'operar aplicacoes generativas com avaliacao, guardrails, observabilidade e '
                'seguranca',
 'scenario': 'deploy de agentes com LLMs',
 'concepts': ['agents', 'RAG', 'tracing'],
 'risks': ['resposta sem fonte', 'avaliacao apenas subjetiva', 'tool use sem trace'],
 'steps': ['Definir ferramenta, entrada permitida e saida esperada.',
           'Avaliar resposta com rubrica curta.',
           'Registrar trace e limite de autonomia.'],
 'gates': [{'name': 'tool_success_rate',
            'value': 0.84,
            'threshold': 0.8,
            'evidence': 'agente chama ferramenta correta'},
           {'name': 'grounded_response',
            'value': 0.78,
            'threshold': 0.75,
            'evidence': 'resposta usa fonte permitida'},
           {'name': 'trace_completo',
            'value': 0.9,
            'threshold': 0.85,
            'evidence': 'trace explica decisao do agente'},
           {'name': 'fallback_seguro',
            'value': 0.82,
            'threshold': 0.8,
            'evidence': 'falha resulta em resposta controlada'}],
