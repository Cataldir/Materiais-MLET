# Atividade do Aluno — 📺 Segurança, Guardrails e Conformidade para LLMs

## Contexto do Problema

Você está evoluindo um projeto de Machine Learning Engineering e precisa incorporar `📺 Segurança, Guardrails e Conformidade para LLMs` de forma verificável. A atividade pede que você traduza o conteúdo da live em uma decisão técnica acompanhada de evidência.
...
A atividade contribui para a etapa em que o grupo precisa integrar dados, modelo, agente, avaliação e governança em uma solução generativa demonstrável e segura. Guarde a evidência em material público do projeto, sem incluir dados privados, credenciais ou respostas prontas.

## Critérios de Autoavaliação

- A decisão tem relação direta com o objetivo da Fase 05.
