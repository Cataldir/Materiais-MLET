# Checklist de Engenharia — 📺 Segurança, Guardrails e Conformidade para LLMs

## Escopo

Use este checklist para verificar se o material `📺 Segurança, Guardrails e Conformidade para LLMs` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
