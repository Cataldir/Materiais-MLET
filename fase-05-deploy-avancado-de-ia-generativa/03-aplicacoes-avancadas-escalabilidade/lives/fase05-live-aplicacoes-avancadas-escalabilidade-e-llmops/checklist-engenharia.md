# Checklist de Engenharia — 📺 Aplicações Avançadas, Escalabilidade e LLMOps

## Escopo

Use este checklist para verificar se o material `📺 Aplicações Avançadas, Escalabilidade e LLMOps` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
