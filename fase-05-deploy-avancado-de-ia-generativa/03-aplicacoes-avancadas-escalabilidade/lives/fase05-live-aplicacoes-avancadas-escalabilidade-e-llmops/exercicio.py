#!/usr/bin/env python3
"""
Script completo de apoio a live: Aplicacoes Avancadas, Escalabilidade e LLMOps
...
PROFILE = {'topic': 'Aplicacoes Avancadas, Escalabilidade e LLMOps',
 'phase_label': 'Fase 05',
 ...
 'phase_focus': 'operar aplicacoes generativas com avaliacao, guardrails, observabilidade e '
                'seguranca',
 'scenario': 'LLMOps e escalabilidade',
 'concepts': ['LLMOps', 'model routing', 'continuous evaluation'],
 'risks': ['resposta sem fonte', 'avaliacao apenas subjetiva', 'tool use sem trace'],
 'steps': ['Separar metricas de custo, qualidade e latencia.',
           'Criar regra simples de roteamento por risco.',
           'Definir amostra para avaliacao continua.'],
 'gates': [{'name': 'roteamento',
            'value': 0.8,
            'threshold': 0.75,
            'evidence': 'requisoes usam modelo adequado ao risco'},
           {'name': 'custo_por_resposta',
            'value': 0.76,
            'threshold': 0.7,
            'evidence': 'custo esta dentro do limite'},
           {'name': 'observabilidade_llm',
            'value': 0.88,
            'threshold': 0.8,
            'evidence': 'tokens, latencia e erro sao medidos'},
           {'name': 'avaliacao_continua',
            'value': 0.82,
            'threshold': 0.75,
            'evidence': 'amostras sao reavaliadas'}],
