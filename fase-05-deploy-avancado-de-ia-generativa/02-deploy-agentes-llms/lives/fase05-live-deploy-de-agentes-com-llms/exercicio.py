#!/usr/bin/env python3
"""
Script completo de apoio a live: Deploy de Agentes com LLMs
...
PROFILE = {'topic': 'Deploy de Agentes com LLMs',
 'phase_label': 'Fase 05',
 ...
 'phase_focus': 'operar aplicacoes generativas com avaliacao, guardrails, observabilidade e '
                'seguranca',
 'scenario': 'pipeline de treino e deploy',
 'concepts': ['CI/CD', 'quality gate', 'rollback'],
 'risks': ['resposta sem fonte', 'avaliacao apenas subjetiva', 'tool use sem trace'],
 'steps': ['Modelar etapas train, evaluate, package e deploy.',
           'Definir metricas que bloqueiam promocao.',
           'Planejar evidencias para anexar a entrega.'],
 'gates': [{'name': 'quality_gate',
            'value': 0.86,
            'threshold': 0.8,
            'evidence': 'pipeline bloqueia modelo inferior'},
           {'name': 'automacao',
            'value': 0.88,
            'threshold': 0.8,
            'evidence': 'etapas rodam sem comando manual oculto'},
           {'name': 'rollback',
            'value': 0.75,
            'threshold': 0.7,
            'evidence': 'ha retorno para versao estavel'},
           {'name': 'evidencia_ci',
            'value': 0.9,
            'threshold': 0.85,
            'evidence': 'execucao deixa logs e artefatos'}],
