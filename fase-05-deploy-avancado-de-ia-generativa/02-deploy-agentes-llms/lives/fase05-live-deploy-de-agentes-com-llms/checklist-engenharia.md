# Checklist de Engenharia — 📺 Deploy de Agentes com LLMs

## Escopo

Use este checklist para verificar se o material `📺 Deploy de Agentes com LLMs` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
