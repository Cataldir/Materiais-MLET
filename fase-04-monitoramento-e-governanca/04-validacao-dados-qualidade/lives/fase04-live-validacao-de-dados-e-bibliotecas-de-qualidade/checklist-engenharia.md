# Checklist de Engenharia — 📺 Validação de Dados e Bibliotecas de Qualidade

## Escopo

Use este checklist para verificar se o material `📺 Validação de Dados e Bibliotecas de Qualidade` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
