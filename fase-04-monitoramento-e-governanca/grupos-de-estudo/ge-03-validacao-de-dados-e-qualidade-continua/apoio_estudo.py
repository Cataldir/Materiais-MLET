#!/usr/bin/env python3
"""
Script completo de apoio ao grupo de estudo: Grupo de Estudos 3 - Validacao de Dados e Qualidade Continua
...
PROFILE = {'topic': 'Grupo de Estudos 3 - Validacao de Dados e Qualidade Continua',
 'phase_label': 'Fase 04',
 ...
 'tech_goal': 'criar evidencias de que o sistema continua correto, seguro, auditavel e '
              'justificavel',
 'decision_options': [{'name': 'Aplicar Grupo de Estudos 3 - Validacao de Dados e Qualidade '
                               'Continua ao Tech Challenge',
                       'impact': 5,
                       'effort': 3,
                       'risk_reduction': 4},
