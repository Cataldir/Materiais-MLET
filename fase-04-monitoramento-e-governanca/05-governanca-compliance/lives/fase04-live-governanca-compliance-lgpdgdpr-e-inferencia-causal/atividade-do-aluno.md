# Atividade do Aluno — 📺 Governança, Compliance (LGPD/GDPR) e Inferência Causal

## Contexto do Problema

Você está evoluindo um projeto de Machine Learning Engineering e precisa incorporar `📺 Governança, Compliance (LGPD/GDPR) e Inferência Causal` de forma verificável. A atividade pede que você traduza o conteúdo da live em uma decisão técnica acompanhada de evidência.
...
A atividade contribui para a etapa em que o grupo precisa criar evidências de que o sistema continua correto, seguro, auditável e justificável ao longo do tempo. Guarde a evidência em material público do projeto, sem incluir dados privados, credenciais ou respostas prontas.

## Critérios de Autoavaliação

- A decisão tem relação direta com o objetivo da Fase 04.
