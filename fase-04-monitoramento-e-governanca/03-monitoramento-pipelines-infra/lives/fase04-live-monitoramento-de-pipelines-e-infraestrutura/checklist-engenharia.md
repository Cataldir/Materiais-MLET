# Checklist de Engenharia — 📺 Monitoramento de Pipelines e Infraestrutura

## Escopo

Use este checklist para verificar se o material `📺 Monitoramento de Pipelines e Infraestrutura` foi aplicado com disciplina de Machine Learning Engineering. Ele deve apoiar revisão por pares e preparação para entrega.
